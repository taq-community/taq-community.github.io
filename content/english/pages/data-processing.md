...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  ...
  <div class="bg-semigold shadow-lg text-body p-6 rounded-lg border-l-4">
    <div class="flex items-center mb-3">
      <span class="text-2xl mr-3">✅</span>
      <h5 class="text-body">Quality Assurance</h5>
    </div>
    <p class="text-body">Validation and quality control of analyses to ensure reliable and accurate results</p>
  </div>
</div>

<div class="flex flex-col items-center justify-center mb-2 mt-6">
    <h3 class="font-bold text-gold">Data Processing Service Providers</h3>
